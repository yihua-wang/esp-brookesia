...
#define ESP_BROOKESIA_PHONE_240_135_DARK_APP_LAUNCHER_ICON_DATA()        \
    {                                                             \
        .main = {                                                 \
            .size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(80),                \
            .layout_row_pad = 1,                                 \
        },                                                        \
        .image = {                                                \
            .default_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(60), \
            .press_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(60),   \
        },                                                        \
        .label = {                                                \
            .text_font = ESP_BROOKESIA_STYLE_FONT_SIZE(14),              \
            .text_color = ESP_BROOKESIA_STYLE_COLOR(0xFFFFFF),           \
        },                                                        \
    }

#define ESP_BROOKESIA_PHONE_240_135_DARK_APP_LAUNCHER_DATA()                       \
    {                                                                       \
        .main = {                                                           \
            .y_start = 0,                                                   \
        ...
        .table = {                                                          \
            .default_num = 3,                                               \
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(80, 80),      \
        },                                                                  \
        .indicator = {                                                      \
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(80, 20),  \
        ...
        .icon = ESP_BROOKESIA_PHONE_240_135_DARK_APP_LAUNCHER_ICON_DATA(),         \
        .flags = {                                                          \
