...
/* Area */
#define ESP_BROOKESIA_PHONE_240_135_DARK_STATUS_BAR_AREA_DATA(w_percent, align) \
    {                                                                    \
...
/* Status Bar */
#define ESP_BROOKESIA_PHONE_240_135_DARK_STATUS_BAR_DATA()                                                       \
    {                                                                                                     \
        .main = {                                                                                         \
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 28),                                            \
            .size_min = {},                                                                               \
            .size_max = {},                                                                               \
        ...
        .area = {                                                                                         \
            .num = 2,                                                                                     \
            .data = {                                                                                     \
                ESP_BROOKESIA_PHONE_240_135_DARK_STATUS_BAR_AREA_DATA(50, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_START),   \
                ESP_BROOKESIA_PHONE_240_135_DARK_STATUS_BAR_AREA_DATA(50, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_END),     \
            },                                                                                            \
        },                                                                                                \
