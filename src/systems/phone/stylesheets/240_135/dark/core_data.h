...
/* Home */
#define ESP_BROOKESIA_PHONE_240_135_DARK_CORE_HOME_DATA()                                      \
    {                                                                                   \
        .background = {                                                                 \
...
/* manager */
#define ESP_BROOKESIA_PHONE_240_135_DARK_CORE_MANAGER_DATA() \
    {                                                 \
        .app = {                                      \
            .max_running_num = 3,                     \
        },                                            \
...
/* Core */
#define ESP_BROOKESIA_PHONE_240_135_DARK_CORE_INFO_DATA_NAME    "240x135 Drak"
#define ESP_BROOKESIA_PHONE_240_135_DARK_CORE_DATA()                     \
    {                                                             \
        .name = ESP_BROOKESIA_PHONE_240_135_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(240, 135),          \
        .home = ESP_BROOKESIA_PHONE_240_135_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_240_135_DARK_CORE_MANAGER_DATA(), \
    }
