...
#define ESP_BROOKESIA_PHONE_466_466_DARK_APP_LAUNCHER_ICON_DATA() \
    {                                                      \
        .main = {                                          \
...
#define ESP_BROOKESIA_PHONE_466_466_DARK_APP_LAUNCHER_DATA()                       \
    {                                                                       \
        .main = {                                                           \
            .y_start = 0,                                                   \
        ...
        .icon = ESP_BROOKESIA_PHONE_466_466_DARK_APP_LAUNCHER_ICON_DATA(),         \
        .flags = {                                                          \
