...
#define ESP_BROOKESIA_PHONE_466_466_DARK_RECENTS_SCREEN_SNAPSHOT_DATA() \
    {                                                            \
        .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(280, 328),           \
        .title = {                                               \
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(280, 42),        \
            .main_layout_column_pad = 10,                        \
            .icon_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(42),           \
            .text_font = ESP_BROOKESIA_STYLE_FONT_SIZE(18),             \
            .text_color = ESP_BROOKESIA_STYLE_COLOR(0xFFFFFF),          \
        },                                                       \
        .image = {                                               \
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(280, 280),       \
            .radius = 5,                                        \
        },                                                       \
    }

#define ESP_BROOKESIA_PHONE_466_466_DARK_RECENTS_SCREEN_DATA()                                    \
    {                                                                                      \
        .main = {                                                                          \
        ...
        .snapshot_table = {                                                                \
            ...
            .snapshot = ESP_BROOKESIA_PHONE_466_466_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(),          \
        },                                                                                 \
        .trash_icon = {                                                                    \
