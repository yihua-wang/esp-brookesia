...
/* Home */
#define ESP_BROOKESIA_PHONE_466_466_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                   \
        .background = {                                                                                 \
...
/* manager */
#define ESP_BROOKESIA_PHONE_466_466_DARK_CORE_MANAGER_DATA() \
    {                                                 \
        .app = {                                      \
            .max_running_num = 3,                     \
        },                                            \
...
/* Core */
#define ESP_BROOKESIA_PHONE_466_466_DARK_CORE_INFO_DATA_NAME    "466x466 Drak"
#define ESP_BROOKESIA_PHONE_466_466_DARK_CORE_DATA()                     \
    {                                                             \
        .name = ESP_BROOKESIA_PHONE_466_466_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(466, 466),          \
        .home = ESP_BROOKESIA_PHONE_466_466_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_466_466_DARK_CORE_MANAGER_DATA(), \
    }
